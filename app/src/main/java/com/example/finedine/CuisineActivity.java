...
import com.example.finedine.HelperClasses.AdapterForDish;
...
public class CuisineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = intent.getIntExtra("cuisine_id", 0);
        ...
        getSupportActionBar().setTitle(cuisine.get(id - 1).getCuisine_name() + " Cuisine");

        AdapterForDish adapter = new AdapterForDish(this, dishes);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), CartAcitivity2.class);
